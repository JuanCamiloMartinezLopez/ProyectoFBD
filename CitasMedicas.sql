...
/*  Created On : 22-jul.-2019 9:45:42 p. m. 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	k_identificacion numeric(11) NOT NULL,	-- Valor numérico el cual ha de ser único para el reconocimiento de una persona, dicho numero es otorgado por la registradora nacional.
	parentezco varchar(20) NULL,
	k_identificacion_afiliado numeric(11) NULL,	-- Valor numérico el cual ha de ser único para el reconocimiento de los beneficiarios que posea un afiliado, dicho número es otorgado por la registradora nacional.
...
(
	...
	k_identificacion numeric(11) NULL,
	k_id_tipo varchar(20) NULL
)
;
...
(
	...
	k_identificacion numeric(11) NOT NULL,
...
ALTER TABLE agenda ADD CONSTRAINT i_estado CHECK (i_estado IN( 'Agendada','Disponible'))
;
...
ALTER TABLE cita ADD CONSTRAINT i_estado CHECK (i_estado IN('Cancelada','Cumplida','Incumplida','Pendiente'))
;
...
ALTER TABLE consultorio ADD CONSTRAINT i_tipo CHECK (i_tipo IN('Medicina general','Pediatria','Oftalmologia','Odontologia'))
;
...
ALTER TABLE especialidad ADD CONSTRAINT n_nombre CHECK (n_nombre IN('Medicina General',
	'Pediatria',
	'Oftalmologia',
	'Odontologia'))
;
...
ALTER TABLE multa ADD CONSTRAINT i_estado CHECK (i_estado IN('Al dia','Debe'))
;
...
ALTER TABLE sede ADD CONSTRAINT n_nombe CHECK (n_nombre IN('Chapinero','Kennedy','Bosa','Suba'))
;
...
ALTER TABLE tipo_cita ADD CONSTRAINT k_id_tipo CHECK (k_id_tipo IN('Prioritaria','Primera vez','Lectura de examenes','Control'))
;
